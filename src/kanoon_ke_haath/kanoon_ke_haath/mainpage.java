...
class mainpage {
    ...
    // "jdbc:mysql://65.1.1.8:3306/test\",\"police\",\"Policemgmt@7police";
    // static String connectionString =
    // "jdbc:hsqldb:file:db_data/database;hsqldb.lock_file=false";
    ...
    public void display() throws IOException {
        ...
        lblkkh = new JLabel(
                "<HTML><h1>KANOON KE HAATH</h1><h3><center><i>Delievering Excellence</i></center></h3></HTML>",
                JLabel.CENTER);
