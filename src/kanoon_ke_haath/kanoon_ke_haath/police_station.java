...
public class police_station {
	...
	public static void user_details() {
		...
		panel2.add(
				new JLabel("<HTML><h1>FILL DETAILS</h1><h3><i><center>Wicked Is Good</center></i></h3></HTML>", JLabel.CENTER));
		panel.add(lblPSName);
		panel1.add(txtPSName);
	...
	public static void add_values() throws ClassNotFoundException, SQLException {
		...
		try {
			...
			// String query = "INSERT INTO police_dept (PD_LOC, PD_CITY, PD_AREA, PD_PHONE,
			// PDREMARKS)
			// VALUES('"+name+"','"+location+"','"+city+"','"+area+"','"+phone+"','"+remarks+"');";
