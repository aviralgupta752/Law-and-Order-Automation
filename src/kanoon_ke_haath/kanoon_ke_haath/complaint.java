...
public class complaint {
	...
	public static void add_values() throws ClassNotFoundException, SQLException {
		...
		// con =
		// DriverManager.getConnection("jdbc:mysql://65.1.1.8:3306/test","police","Policemgmt@7police");
		//
		...
		// int stat=0;
		//
		// String sql="INSERT INTO fir (FIR_NAME, FIR_FNAME, FIR_EMAIL, FIR_CONTACT,
		// FIR_DOI, FIR_PS, FIR_DEP, FIR_DESC, FIR_STAT, FIR_EMAIL_SENT, FIR_PO_ID)
		// VALUES(?,?,?,?,?,?,?,?,?,?,?)";
		// PreparedStatement pst = con.prepareStatement(sql);
		//
		// pst.setString(1, name);
