...
class mainpage {
  ...
  static JButton aboutBtn, quitBtn, admin_loginBtn, police_loginBtn, register_complaintBtn, register_applicationBtn,
      track_complaintBtn, police_applicationBtn;
  ...
  public static void display() {
    ...
    police_applicationBtn = new JButton("<HTML><h2>Apply for a police officer job</h2></HTML>");
    ...
    police_applicationBtn.addActionListener(new CustomActionListener());
    ...
    panel1.add(police_applicationBtn);
    panel1.add(quitBtn);
  ...
  static class CustomActionListener implements ActionListener {
    public void actionPerformed(ActionEvent ae) {
      ...
      } else if (source == police_applicationBtn) {
