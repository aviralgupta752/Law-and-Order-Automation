...
public class officer
{
	...
	static void display()
	{
		...
		model.addRow(new Object[]{"2", "a", "b", "@", "33", "43", "all", "cc", "fssfsfsf"});
	
		table = new JTable(model);
		table.getModel().addTableModelListener(new TableModelListener() {
			public void tableChanged(TableModelEvent e) {
				// int caseid = table.getValueAt(e.getFirstRow(), 0);
				// String val = table.getValueAt(e.getFirstRow(), e.getColumn());

				System.out.println(table.getValueAt(e.getFirstRow(), 0));
