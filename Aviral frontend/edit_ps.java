...
public class edit_ps{
	...
	static JLabel lblheading, lblspace, lblPSName, lblLocation, lblCity, lblArea, lblPhone, lblRemarks;
	...
	public static void user_details()
	{
		...
		panel2.add(new JLabel("<HTML><h1>EDIT POLICE STATION</h1></HTML>", JLabel.CENTER));
