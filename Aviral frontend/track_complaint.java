...
//	static JComboBox txtDepartment;
	...
	{   
		...
		panel1 = new JPanel(new GridLayout(12,1,10,10));
		...
		// USER DETAILS
			...
			btnCancel = new JButton("<HTML><h2>Cancel</h2></HTML>");
...
//			txtDepartment.setSelectedIndex(0);
			...
			panel2.add(new JLabel("<HTML><h1><center>What is a police complaint?</h1><h3>A Police Complaint is initial reporting of any crime or offence. It is a narration of facts about the incident in layman’s words.</h3><h1>When can a police complaint be filed?</h1><h2>One should ideally file a police complaint immediately after the incident/crime have taken place. In certain cases of sexual harassment, domestic violence, rape, etc. women usually take time to come out and report the crime/incident due to mental trauma. In such cases, even if there is a delay one can file a police complaint.</h2><h1>Who can file a Police Complaint?</h1><h2>Anyone can file a police complaint. The victim of the crime, victim’s family members, friends or any witness to the crime can file a police complaint.</h2></HTML> ", JLabel.CENTER));
//                        panel2.add(stat);
